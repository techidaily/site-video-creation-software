...
// ------------------------------------------------------------------------------------------- 以下内容需要自己替换
const subSiteAuthor = 'Isabella';
const subSiteKeywords = `ai video creator, smart video software,video creation` + ','; // 关键字，多个关键字用逗号分隔
const indexNowKey = '4e6c43142b0144b58845cbb0af6217e3'; // 替换为你的API密钥
